...
var msg = document.getElementById("msg");
    ...
    var regexpmail = /^([\w\.-]+)@([A-Za-z0-9\-]+)\.([a-z]{2,3})(.[a-z]{2,3})?$/;
                    ...
                    if(regexp2.test(paswrd.value)){
                        ...
                        if(regexp3.test(paswrd.value)){
                            ...
                            if(paswrd.value == confirmPwd.value){
                                ...
                                document.getElementById("confirmPawd").innerHTML = "Enter same password on both field";                        
                                return false;
                            }
                        }
                        else{
                            document.getElementById("paswderror").innerHTML = "Password should contain minimum 8 characters includig uppercase and lowercase letters,numbers and special charcter";
                            return false;
                        }
                } 
                else{
